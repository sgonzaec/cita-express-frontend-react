...
const Home = () => {
    const { circleEvent, displayText } = HomeServices()
    return (
        <MainTemplate>
                ...
                <div className="content">
                    ...
                    <div className="right">
                        <div className="boxCircle">
                            <button className="brown" onClick={() => circleEvent("brown")}></button>
                            <button className="orange" onClick={() => circleEvent("orange")}></button>
                            <button className="blue" onClick={() => circleEvent("blue")}></button>
                        </div>
